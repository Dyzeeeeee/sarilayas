<template>
  <AdminLayout>
    <div class="space-y-4">
      <!-- Header -->
      <div>
        <h1 class="text-xl font-semibold text-gray-900 tracking-tight">Officers</h1>
        <p class="text-xs text-gray-500 mt-1">Manage organization officers</p>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-3">
          ...
          <div class="flex space-x-2">
            ...
            >
              ...
              <span>{{ loading ? 'Saving...' : editingOfficer ? 'Update' : 'Add' }} Officer</span>
            </button>
            <button
              v-if="editingOfficer"
              type="button"
        ...
        <div class="px-4 py-3 border-b border-gray-200/80">
          <h2 class="text-sm font-semibold text-gray-900">Current Officers</h2>
        </div>
        <div class="p-4 flex-1 overflow-y-auto max-h-[600px]">
          ...
          <div v-else class="space-y-2">
            ...
            >
              <div v-if="officer.photo" class="flex-shrink-0">
                <img
                  :src="officer.photo"
                  :alt="officer.name"
