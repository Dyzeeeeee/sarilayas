...
const defaultSettings = {
  ...
  primaryColor: '#9333ea',
  // News Page Text Customization (Admin)
  newsPageTitle: 'News',
  newsPageDescription: 'Manage news articles and announcements',
  newsPageHeaderText: 'All Articles',
  newsPageTitleFontSize: 'text-2xl',
  newsPageTitleFontWeight: 'font-semibold',
  newsPageDescriptionFontSize: 'text-sm',
  newsPageDescriptionFontWeight: 'font-normal',
  newsPageHeaderFontSize: 'text-lg',
  newsPageHeaderFontWeight: 'font-semibold',
  // Projects Page Text Customization (Admin)
  projectsPageTitle: 'Projects',
  projectsPageDescription: 'Manage organization projects',
  projectsPageHeaderText: 'All Projects',
  projectsPageTitleFontSize: 'text-2xl',
  projectsPageTitleFontWeight: 'font-semibold',
  projectsPageDescriptionFontSize: 'text-sm',
  projectsPageDescriptionFontWeight: 'font-normal',
  projectsPageHeaderFontSize: 'text-lg',
  projectsPageHeaderFontWeight: 'font-semibold',
  // Projects Public Pages
  projectsCardTitleFontSize: 'text-xl sm:text-2xl',
  projectsCardTaglineFontSize: 'text-sm sm:text-base',
  projectsCardDescriptionFontSize: 'text-sm',
  projectDetailTitleFontSize: 'text-3xl sm:text-4xl',
  projectDetailTaglineFontSize: 'text-xl sm:text-2xl',
  projectDetailDescriptionFontSize: 'text-lg',
  projectDetailContentFontSize: 'text-base',
  // News Public Pages
  newsHeadlineTitleFontSize: 'text-2xl sm:text-4xl',
  newsCardTitleFontSize: 'text-sm',
  newsCardDateFontSize: 'text-[10px] sm:text-xs',
  newsDetailTitleFontSize: 'text-3xl sm:text-4xl',
  newsDetailDescriptionFontSize: 'text-lg',
  newsDetailContentFontSize: 'text-base',
}
...
export const settingsService = {
  ...
  async getSettings() {
    ...
    return {
      ...
      // News Page Text
      newsPageTitle: settings.newsPageTitle || defaultSettings.newsPageTitle,
      newsPageDescription: settings.newsPageDescription || defaultSettings.newsPageDescription,
      newsPageHeaderText: settings.newsPageHeaderText || defaultSettings.newsPageHeaderText,
      newsPageTitleFontSize: settings.newsPageTitleFontSize || defaultSettings.newsPageTitleFontSize,
      newsPageTitleFontWeight: settings.newsPageTitleFontWeight || defaultSettings.newsPageTitleFontWeight,
      newsPageDescriptionFontSize: settings.newsPageDescriptionFontSize || defaultSettings.newsPageDescriptionFontSize,
      newsPageDescriptionFontWeight: settings.newsPageDescriptionFontWeight || defaultSettings.newsPageDescriptionFontWeight,
      newsPageHeaderFontSize: settings.newsPageHeaderFontSize || defaultSettings.newsPageHeaderFontSize,
      newsPageHeaderFontWeight: settings.newsPageHeaderFontWeight || defaultSettings.newsPageHeaderFontWeight,
      // Projects Page Text (Admin)
      projectsPageTitle: settings.projectsPageTitle || defaultSettings.projectsPageTitle,
      projectsPageDescription: settings.projectsPageDescription || defaultSettings.projectsPageDescription,
      projectsPageHeaderText: settings.projectsPageHeaderText || defaultSettings.projectsPageHeaderText,
      projectsPageTitleFontSize: settings.projectsPageTitleFontSize || defaultSettings.projectsPageTitleFontSize,
      projectsPageTitleFontWeight: settings.projectsPageTitleFontWeight || defaultSettings.projectsPageTitleFontWeight,
      projectsPageDescriptionFontSize: settings.projectsPageDescriptionFontSize || defaultSettings.projectsPageDescriptionFontSize,
      projectsPageDescriptionFontWeight: settings.projectsPageDescriptionFontWeight || defaultSettings.projectsPageDescriptionFontWeight,
      projectsPageHeaderFontSize: settings.projectsPageHeaderFontSize || defaultSettings.projectsPageHeaderFontSize,
      projectsPageHeaderFontWeight: settings.projectsPageHeaderFontWeight || defaultSettings.projectsPageHeaderFontWeight,
      // Projects Public Pages
      projectsCardTitleFontSize: settings.projectsCardTitleFontSize || defaultSettings.projectsCardTitleFontSize,
      projectsCardTaglineFontSize: settings.projectsCardTaglineFontSize || defaultSettings.projectsCardTaglineFontSize,
      projectsCardDescriptionFontSize: settings.projectsCardDescriptionFontSize || defaultSettings.projectsCardDescriptionFontSize,
      projectDetailTitleFontSize: settings.projectDetailTitleFontSize || defaultSettings.projectDetailTitleFontSize,
      projectDetailTaglineFontSize: settings.projectDetailTaglineFontSize || defaultSettings.projectDetailTaglineFontSize,
      projectDetailDescriptionFontSize: settings.projectDetailDescriptionFontSize || defaultSettings.projectDetailDescriptionFontSize,
      projectDetailContentFontSize: settings.projectDetailContentFontSize || defaultSettings.projectDetailContentFontSize,
      // News Public Pages
      newsHeadlineTitleFontSize: settings.newsHeadlineTitleFontSize || defaultSettings.newsHeadlineTitleFontSize,
      newsCardTitleFontSize: settings.newsCardTitleFontSize || defaultSettings.newsCardTitleFontSize,
      newsCardDateFontSize: settings.newsCardDateFontSize || defaultSettings.newsCardDateFontSize,
      newsDetailTitleFontSize: settings.newsDetailTitleFontSize || defaultSettings.newsDetailTitleFontSize,
      newsDetailDescriptionFontSize: settings.newsDetailDescriptionFontSize || defaultSettings.newsDetailDescriptionFontSize,
      newsDetailContentFontSize: settings.newsDetailContentFontSize || defaultSettings.newsDetailContentFontSize,
    }
  },
